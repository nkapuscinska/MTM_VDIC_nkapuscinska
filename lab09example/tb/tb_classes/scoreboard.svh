 ...
 */
class scoreboard extends uvm_subscriber #(result_item);
...
//------------------------------------------------------------------------------
    ...
    local function result_item predict_result(sequence_item cmd);
        result_item predicted;
...
//------------------------------------------------------------------------------
    ...
    function void write(result_item t);
        string data_str;
        sequence_item cmd;
        result_item predicted;
