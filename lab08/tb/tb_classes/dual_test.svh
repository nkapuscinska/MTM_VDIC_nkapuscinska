...
//------------------------------------------------------------------------------
    ...
    function void build_phase(uvm_phase phase);
        ...
        virtual switch_bfm class_bfm;
        virtual switch_bfm module_bfm;

        env_config env_config_h;

        if(!uvm_config_db #(virtual switch_bfm)::get(this, "","class_bfm", class_bfm))
            `uvm_fatal("DUAL TEST", "Failed to get CLASS BFM");
        if(!uvm_config_db #(virtual switch_bfm)::get(this, "","module_bfm", module_bfm))
